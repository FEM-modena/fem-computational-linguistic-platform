...
# Domande di ricerca e indicazioni per lo svolgimento
...
5. Fai scaricare la tabella da compilare (@@LINK@@): ciascun gruppo inserirà in alto il nome del proprio personaggio e leggerà le categorie che si chiede di assegnare a ciascun verbo: processo materiale, comportamentale, mentale, verbale, relazionale, esistenziale (non è obbligatorio utilizzare tutte le categorie)
...
7. Restituzione collettiva: Presentate reciprocamente le scoperte delle vostre analisi e fate nascere una discussione. Potete lasciarvi guidare da domande come: 
...
## Discorso diretto
*Come si esprimono i personaggi? I discorsi diretti identificano degli stereotipi di genere?*

1. Aprite il corpus di Voyant a questo link. Prendetevi del tempo per familiarizzare con lo strumento (trovi una guida rapida @@qui@@) 
2. Chiedi a ciascun* student* di cercare il nome di un personaggio del romanzo nella casella di testo dello strumento Contesti. 
NB: Ti consigliamo di organizzare l’attività in gruppi, assegnando un personaggio a ciascun gruppo!
3. Riportate nella tabella i discorsi diretti dei personaggi seguendo l'esempio di seguito:
### <a href="https://voyant-tools.org/?corpus=cd04628b21b65568d5a462fea9e58720&stopList=keywords-84cb956a2dfe65680cdf2ff5429350d8&query=maruzza&view=Contexts" target="_blank">Maruzza</a>  
<table>
<tbody>
<tr>
...
4. Restituzione collettiva: Presentate reciprocamente le scoperte delle vostre analisi. Cercate analogie e differenze tra i discorsi diretti individuati, riflettendo su forma, contenuto, scopo comunicativo. Alcune domande guida possono essere:
...
*Quali sono le caratteristiche fisiche e psicologiche dei personaggi? Rispecchiano i comuni stereotipi di genere?*

1. Dopo aver identificato i personaggi principali dell’opera, provate a raccontarvi/scrivere quali caratteristiche vi aspettate che abbiano. 
2. Chiedi a ciascun* student* di aprire il corpus di Voyant a questo link. Prendetevi del tempo per familiarizzare con lo strumento (trovi una guida rapida @@qui@@) 
...
NB: Ti consigliamo di organizzare l’attività in gruppi, assegnando un personaggio a ciascun gruppo!
4. Scrivete nella tabella gli NUMERO@@@ le caratteristiche, fisiche o psicologiche, che riuscite a trovare nel contesto del personaggio. Fate riferimento all’esempio in tabella ma sentitevi liberi di aggiungere qualsiasi cosa vi sembri rilevante: ogni personaggio è diverso, ogni testo è diverso!
...
5. Restituzione collettiva: Presentate reciprocamente le scoperte delle vostre analisi e fate nascere una discussione. Potete lasciarvi guidare da domande come:
